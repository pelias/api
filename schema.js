    ...
    api: Joi.object()
      ...
      .keys({
        ...
        localization: Joi.object()
          .keys({
            flipNumberAndStreetCountries: Joi.array().items(
        ...
        services: Joi.object()
          ...
          .unknown(false)
          .default({}), // default api.services to an empty object
        defaultParameters: Joi.object()
          .keys({
