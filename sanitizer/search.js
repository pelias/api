...
module.exports.middleware = (_api_pelias_config) => {
  var sanitizers = {
    ...
    layers: require('../sanitizer/_targets')(
      'layers',
      type_mapping.layer_mapping,
    ),
    sources: require('../sanitizer/_targets')(
      'sources',
      type_mapping.source_mapping,
    ),
    address_layer_filter: require('../sanitizer/_address_layer_filter')(
      type_mapping,
    ),
    ...
    location_bias: require('../sanitizer/_location_bias')(
      _api_pelias_config.defaultParameters,
    ),
