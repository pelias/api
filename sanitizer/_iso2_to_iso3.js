...
function _sanitize(raw, clean) {
  ...
  if (
    clean.hasOwnProperty('parsed_text') &&
    iso3166.isISO2Code(clean.parsed_text.country)
  ) {
    clean.parsed_text.country = iso3166.convertISO2ToISO3(
      clean.parsed_text.country,
    );
  }
