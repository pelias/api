...
module.exports.tests.query = function(test, common) {
  ...
  test('parsed_text with all fields should use FallbackQuery', function(t) {
    ...
    t.deepEqual(compiled.type, 'search_fallback', 'query type set');
    common.deepEqual(t, compiled.body, expected, 'fallbackQuery');
    t.end();
  ...
  test('valid multi boundary.country search', function(t) {
    ...
    t.deepEqual(compiled.type, 'search_fallback', 'query type set');
    common.deepEqual(t, compiled.body, expected, 'search: valid multi boundary.country query');
    t.end();
  });
  ...
  test('categories filter', function(t) {
    ...
    t.deepEqual(compiled.type, 'search_fallback', 'query type set');
    common.deepEqual(t, compiled.body, expected, 'valid search query with category filtering');
    t.end();
  });
...
module.exports.tests.city_country = function(test, common) {
  ...
  test('valid postalcode only search', function(t) {
    ...
    t.deepEqual(compiled.type, 'search_fallback', 'query type set');
    common.deepEqual(t, compiled.body, expected, 'search_fallback_postalcode_only');
    t.end();
  });
