...
module.exports.tests.query = function (test, common) {
  ...
  test('parsed_text with single admin field should return undefined', function (t) {
    ['neighbourhood', 'borough', 'city', 'county', 'state', 'country'].forEach(
      function (placeType) {
        var clean = {
          parsed_text: {},
        };
  ...
  test('valid boundary.country search', function (t) {
    ...
    t.deepEqual(
      compiled.body,
      expected,
      'search: valid boundary.country query',
    );
    t.end();
  });
  ...
  test('valid multi boundary.country search', function (t) {
    ...
    t.deepEqual(
      compiled.body,
      expected,
      'search: valid multi boundary.country query',
    );
    t.end();
  });
  ...
  test('valid sources filter', function (t) {
    ...
    t.deepEqual(
      compiled.body,
      expected,
      'search: valid search query with source filtering',
    );
    t.end();
  });
  ...
  test('categories filter', function (t) {
    ...
    t.deepEqual(
      compiled.body,
      expected,
      'valid search query with category filtering',
    );
    t.end();
  });
};
