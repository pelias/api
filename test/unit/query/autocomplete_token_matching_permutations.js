...
const defaults = new peliasQuery.Vars(
...
const views = {
  ...
  ngrams_last_token_only_multi:
    require('../../../query/view/ngrams_last_token_only_multi')(adminFields),
...
function assert(t, actual, expected, debug) {
  ...
  t.deepEqual(
    _actual.body.query.bool,
    _expected,
    'autocomplete_token_matching_permutations',
  );
  t.end();
}
...
module.exports.all = function (tape, common) {
  function test(name, testFunction) {
    return tape(
      'autocomplete token matching permutations: ' + name,
      testFunction,
    );
  }
