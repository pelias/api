...
module.exports.tests.query = function (test, common) {
  ...
  test('valid lingustic autocomplete with 3 tokens', function (t) {
    ...
    t.deepEqual(
      compiled.body,
      expected,
      'autocomplete_linguistic_multiple_tokens',
    );
    t.end();
  });
  ...
  test('valid lingustic autocomplete with 3 tokens - first two are numeric', function (t) {
    ...
    t.deepEqual(
      compiled.body,
      expected,
      'autocomplete_linguistic_multiple_tokens_complete_numeric',
    );
    t.end();
  });
  ...
  test('valid lingustic autocomplete one character token', function (t) {
    ...
    t.deepEqual(
      compiled.body,
      expected,
      'autocomplete_linguistic_one_char_token',
    );
    t.end();
  });
  ...
  test('valid lingustic autocomplete two character token', function (t) {
    console.log(
      `config value: ${configWithCustomSettings
        .generate()
        .get('api.autocomplete.exclude_address_length')}`,
    );
    var query = generate_custom({
      text: 'te',
      tokens: ['te'],
    ...
    t.deepEqual(
      compiled.body,
      expected,
      'autocomplete_linguistic_two_char_token',
    );
    t.end();
  });
  ...
  test('valid lingustic autocomplete three character token', function (t) {
    ...
    t.deepEqual(
      compiled.body,
      expected,
      'autocomplete_linguistic_three_char_token',
    );
    t.end();
  });
  ...
  test('autocomplete + focus on null island', function (t) {
    ...
    t.deepEqual(
      compiled.body,
      expected,
      'autocomplete_linguistic_focus_null_island',
    );
    t.end();
  });
  ...
  test('valid sources filter', function (t) {
    ...
    t.deepEqual(
      compiled.body,
      expected,
      'valid autocomplete query with source filtering',
    );
    t.end();
  });
  ...
  test('valid layers filter', function (t) {
    ...
    t.deepEqual(
      compiled.body,
      expected,
      'valid autocomplete query with layer filtering',
    );
    t.end();
  });
  ...
  test('valid categories filter', function (t) {
    ...
    t.deepEqual(
      compiled.body,
      expected,
      'valid autocomplete query with category filtering',
    );
    t.end();
  });
  ...
  test('single character street address', function (t) {
    ...
    t.deepEqual(
      compiled.body,
      expected,
      'autocomplete_single_character_street',
    );
    t.end();
  });
  ...
  test('valid boundary.country search', function (t) {
    ...
    t.deepEqual(
      compiled.body,
      expected,
      'autocomplete: valid boundary.country query',
    );
    t.end();
  });
  ...
  test('autocomplete + bbox around San Francisco', function (t) {
    ...
    t.deepEqual(
      compiled.body,
      expected,
      'autocomplete_linguistic_bbox_san_francisco',
    );
    t.end();
  });
  ...
  test('autocomplete + circle around San Francisco', function (t) {
    ...
    t.deepEqual(
      compiled.body,
      expected,
      'query matches autocomplete_linguistic_circle_san_francisco fixture',
    );
    t.end();
  });
  ...
  test('valid boundary.gid search', function (t) {
    ...
    t.deepEqual(
      compiled.body,
      expected,
      'autocomplete: valid boundary.gid query',
    );
    t.end();
  });
};
