                ...
                must: [
                  {
                    multi_match: {
                      query: 'city value',
                      type: 'phrase',
                      fields: ['parent.localadmin', 'parent.localadmin_a'],
                    },
                  },
                  {
                    multi_match: {
                ...
                must: [
                  {
                    multi_match: {
                      query: 'county value',
                      type: 'phrase',
                      fields: ['parent.county', 'parent.county_a'],
                    },
                  },
                  {
                    multi_match: {
                ...
                must: [
                  {
                    multi_match: {
                      query: 'county value',
                      type: 'phrase',
                      fields: ['parent.macrocounty', 'parent.macrocounty_a'],
                    },
                  },
                  {
                    multi_match: {
                ...
                must: [
                  {
                    multi_match: {
                      query: 'state value',
                      type: 'phrase',
                      fields: ['parent.macroregion', 'parent.macroregion_a'],
                    },
                  },
                  {
                    multi_match: {
                ...
                must: [
                  {
                    multi_match: {
                      query: 'country value',
                      type: 'phrase',
                      fields: ['parent.dependency', 'parent.dependency_a'],
                    },
                  },
                ],
                filter: {
