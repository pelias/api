...
module.exports.tests.isNameDifferent = function (test, common) {
  ...
  test('basic matching', function (t) {
    t.false(
      isNameDifferent({ name: { default: 'a' } }, { name: { default: 'a' } }),
      'basic match',
    );
  ...
  test('inter-language matching', function (t) {
    t.false(
      isNameDifferent({ name: { default: 'a' } }, { name: { foo: 'a' } }),
      'match default with any lang',
    );

    t.false(
      isNameDifferent({ name: { foo: 'a' } }, { name: { default: 'a' } }),
      'match default with any lang - inverse',
    );

    t.false(
      isNameDifferent({ name: { bar: 'a' } }, { name: { foo: 'a' } }, 'bar'),
      'match using request lang',
    );

    t.false(
      isNameDifferent({ name: { bar: 'a' } }, { name: { foo: 'a' } }, 'foo'),
      'match using request lang - inverse',
    );

    // note: this returns true
    t.true(
      isNameDifferent({ name: { foo: 'a' } }, { name: { bar: 'a' } }),
      'different lang',
    );
