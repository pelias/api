...
module.exports.tests.interface = function (test) {
  test('valid interface', function (t) {
    ...
    t.equal(
      typeof TypeMapping.addStandardTargetsToAliases,
      'function',
      'addStandardTargetsToAliases() is a function',
    );
    t.equal(
      typeof TypeMapping.prototype.setSourceAliases,
      'function',
      'setSourceAliases() is a function',
    );

    t.equal(
      typeof TypeMapping.prototype.setLayersBySource,
      'function',
      'setLayersBySource() is a function',
    );
    t.equal(
      typeof TypeMapping.prototype.setLayerAliases,
      'function',
      'setLayerAliases() is a function',
    );

    t.equal(
      typeof TypeMapping.prototype.generateMappings,
      'function',
      'generateMappings() is a function',
    );

    t.equal(
      typeof TypeMapping.prototype.loadTargets,
      'function',
      'loadTargets() is a function',
    );
    t.equal(
      typeof TypeMapping.prototype.load,
      'function',
      'load() is a function',
    );
...
module.exports.tests.addStandardTargetsToAliases = function (test) {
  test('static method addStandardTargetsToAliases', function (t) {
    ...
    t.deepEqual(TypeMapping.addStandardTargetsToAliases([], aliases), {
      test: ['test2'],
    });
    ...
    t.deepEqual(TypeMapping.addStandardTargetsToAliases(['baz'], aliases), {
      test: ['test2'],
      baz: ['baz'],
    });
    t.deepEqual(aliases, aliases, 'aliases object not mutated');
