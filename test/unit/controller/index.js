...
module.exports.tests.interface = function (test, common) {
  test('valid interface', function (t) {
    ...
    t.equal(
      typeof setup({}, './public/apiDoc.md'),
      'function',
      'setup returns a controller',
    );
    t.end();
  });
};
  ...
  test('returns server info in json', function (t) {
    ...
    var res = {
      json: function (json) {
        ...
        t.assert(
          json.hasOwnProperty('markdown'),
          'return object contains markdown property',
        );
        t.assert(
          json.hasOwnProperty('html'),
          'return object contains html property',
        );
        t.end();
      },
    };
...
module.exports.tests.info_html = function (test, common) {
  test('returns server info in html', function (t) {
    ...
    var setup = proxyquire('../../../controller/markdownToHtml', {
      fs: fsMock,
    });
