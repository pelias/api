...
var customConfig = {
  generate: function generate() {
    return {
      api: {
        localization: {
          // expand the set of flipped countries
...
var localNamingConventions = proxyquire(
  '../../../middleware/localNamingConventions',
  { 'pelias-config': customConfig },
);
...
module.exports.tests.flipNumberAndStreet = function (test, common) {
  ...
  var req = {},
    res = {
      data: [ukAddress, deAddress, nlAddress, esAddress, unknownCountryAddress],
    },
    middleware = localNamingConventions();
