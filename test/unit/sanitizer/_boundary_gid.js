...
module.exports.tests.sanitize_boundary_gid = function (test, common) {
  ...
  test('non-string boundary.gid should set boundary.gid to undefined and return warning', function (t) {
    ...
    t.deepEquals(
      errorsAndWarnings,
      { errors: ['boundary.gid is not a string'], warnings: [] },
      'non-string boundary_gid warning',
    );
    t.end();
  });
  ...
  test('wrong format for boundary.gid in raw should set boundary.gid to undefined', function (t) {
    ...
    t.deepEquals(
      errorsAndWarnings,
      {
        errors: ['whosonfirst:123 does not follow source:layer:id format'],
        warnings: [],
      },
  ...
  test('wrong format for boundary.gid in raw should set boundary.gid to undefined', function (t) {
    ...
    t.deepEquals(
      ...
      {
        errors: [
          'whosonfirst:neighbourhood:123:a:b does not follow source:layer:id format',
        ],
        warnings: [],
      },
      'wrong format boundary_gid error',
