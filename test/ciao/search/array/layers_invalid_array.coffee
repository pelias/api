...
#? expected errors
should.exist json[0].geocoding.errors
should.exist json[1].geocoding.errors
json[0].geocoding.errors.should.eql [ '\'notlayer\' is an invalid layers parameter. Valid options: coarse,address,venue,country,region,county,locality,continent,macrocountry,dependency,localadmin,macrohood,neighbourhood,microhood,disputed' ]
