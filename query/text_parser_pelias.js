 ...
 */
const adminFields = placeTypes.concat(['region_a']);
...
function addParsedVariablesToQueryVariables(clean, vs) {
  ...
  // street name
  if (
    !_.isEmpty(clean.parsed_text.street) &&
    _.isEmpty(clean.parsed_text.cross_street)
  ) {
  ...
  // postcode
  if (
    !_.isEmpty(clean.parsed_text.postcode) &&
    _.isEmpty(clean.parsed_text.cross_street)
  ) {
